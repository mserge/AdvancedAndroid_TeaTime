...
//  (1) Implement ImageDownloader.DelayerCallback
public class MenuActivity extends AppCompatActivity implements  ImageDownloader.DelayerCallback {
    ...
    //  (2) Add a SimpleIdlingResource variable that will be null in production
    @Nullable
    private SimpleIdlingResource mIdlingResource;
    private GridView gridview;

    /**
     *  (3) Create a method that returns the IdlingResource variable. It will
    ...
    //  (5) Override onDone so when the thread in ImageDownloader is finished, it returns an
